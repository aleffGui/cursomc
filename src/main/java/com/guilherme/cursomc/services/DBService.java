...
public class DBService {
	...
	public void instantiateDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Guilherme Ferreira", "alefff.guilherme@gmail.com", "43947557457",
				TipoCliente.PESSOAFISICA, encoder.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana costa", "galexferreira@gmail.com", "998458745", TipoCliente.PESSOAFISICA,
				encoder.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("08/11/2021 00:00"),
				null);
